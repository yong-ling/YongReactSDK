#
#  Be sure to run `pod spec lint ReactSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "ReactSDK is a quick helper for testing cocoapods. And it includes a demo and dynamic framework"
  ...
  spec.author             = { "Yong Ling" => "johnnyling.au@gmail.com" }
  # Or just: spec.author    = "Yong Ling"
  # spec.authors            = { "Yong Ling" => "johnnyling.au@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Yong Ling"
